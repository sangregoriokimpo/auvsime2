...
: ${AMENT_CURRENT_PREFIX:="/home/sangregorioquimpo/auve2_ws/install/auv_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/auv_description/environment/library_path.sh"
